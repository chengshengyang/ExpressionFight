...
public class AlbumAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            mHolder.iv_album = convertView.findViewById(R.id.album_iv);
            mHolder.tv_name = convertView.findViewById(R.id.album_name_tv);
            mHolder.tv_count = convertView.findViewById(R.id.album_count_tv);
